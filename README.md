...
- [x] Implement a feature that allows the user to restore the initial state, meaning that all deleted rows will be recovered and color rows and order by country reset.
...
- [] Paginator
- [] Extract to customs hooks and do a clean code.
- [] tests
